<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Vedio2.aspx.cs" Inherits="Vedio2" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>The person you really need to marry | Tracy McMillan</title>
</head>
...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
  ...
  <div class="v_title">The person you really need to marry | Tracy McMillan</div>
 <div class="text-center" id="player" style="margin-left:300px;"  >  </div>   <%--youtube影片--%>
        <div style="float:right;margin-top:50px;margin-left:50px;" >
           <input type="button"  id="focus" runat="server" value="查看數據"   style="width:150px;color:#000;margin-right:30px" OnClick="data_click" />
